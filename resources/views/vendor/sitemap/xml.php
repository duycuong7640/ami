...
<?php foreach ($items as $item) : ?>
	...
	<loc><?= $item['loc'] ?></loc>
<?php
echo "\t\t" . '<xhtml:link rel="alternate" hreflang="en" href="' . $item['loc'] . '" />' . "\n";
foreach (["id", "ph", 'fi'] as $value) {
    echo "\t\t" . '<xhtml:link rel="alternate" hreflang="' . $value . '" href="' . \App\Helpers\Helpers::checkLangSitemap($value, $item['loc']) . '" />' . "\n";
}
