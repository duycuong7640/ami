...
{{--                                    <div style="overflow: hidden;">--}}
{{--                                        <div style="width: 140px; float: left; font-size: 13px; margin-top: 10px;">{{ (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]" }}</div>--}}
{{--                                        <div style="margin-left: 140px;"><input type="text" name="url_to" class="form-control" placeholder=""/></div>--}}
{{--                                    </div>--}}
                                    <input type="text" name="url_to" class="form-control" placeholder=""/>
...
@section('validate')
    {!! JsValidator::formRequest('Modules\Admins\Http\Requests\RedirectUrl\CreateRequest','#form-create'); !!}
@endsection
