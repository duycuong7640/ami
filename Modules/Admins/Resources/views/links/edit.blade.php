                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Tên - Indonesia</label>
                                <input type="text" name="title_id" value="{{ $data['detail']->title_id }}" class="form-control" placeholder=""/>
                            </div>
                            <div class="form-group">
                                <label>Tên - Philippines</label>
                                <input type="text" name="title_ph" value="{{ $data['detail']->title_ph }}" class="form-control" placeholder=""/>
                            </div>
{{--                            <div class="form-group">--}}
