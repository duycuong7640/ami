                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="tab_es" class="tabHide" style="display: none;">
                                ...
                                <div class="form-group">
                                    <label>Tiêu đề 2</label>
                                    <input type="text" name="title2_es" class="form-control" placeholder=""/>
                                </div>
                                <div class="form-group">
                                    <label>Mô tả</label>
                                    <textarea name="description_es" placeholder="Mô tả" rows="4"
                                              class="form-control ckeditor"></textarea>
                                </div>
                            </div>
                            <div id="tab_pt" class="tabHide" style="display: none;">
                                ...
                                <div class="form-group">
                                    <label>Tiêu đề</label>
                                    <input type="text" name="title_pt" class="form-control" placeholder=""/>
                                </div>
                                <div class="form-group">
                                    <label>Tiêu đề 2</label>
                                    <input type="text" name="title2_pt" class="form-control" placeholder=""/>
                                </div>
                                <div class="form-group">
                                    <label>Mô tả</label>
                                    <textarea name="description_pt" placeholder="Mô tả" rows="4"
                                              class="form-control ckeditor"></textarea>
                                </div>
                            </div>
                        </div>
