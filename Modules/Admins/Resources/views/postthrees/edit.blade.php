...
@section('content')
    <div class="content-wrapper">
        <form method="post" action="" class="forms-sample" id="form-edit">
                    ...
                    <div class="d-flex flex-column flex-md-row align-items-center">
                        ...
                        <div class="wrapper ml-md-auto d-flex flex-column flex-md-row kanban-toolbar ml-n2 ml-md-0 mt-4 mt-md-0">
                            <div class="d-flex mt-4 mt-md-0">
                                ...
                                <a href="{{ route('admin.postthree.index') }}">
                            ...
                            <div id="tab_vn" class="tabHide">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"
                                              name="description" rows="10">{{ $data['detail']->description }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Iframe</label>
                                    <textarea class="form-control"
                                              name="content" rows="10">{{ str_replace('\"','"', $data['detail']->content) }}</textarea>
                                </div>
                                <div class="form-group">
            ...
            <div class="row tabHide" id="tab_vn_seo1" style="display: none;">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
            ...
            <div class="row tabHide" id="tab_en_seo1" style="display: none;">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
