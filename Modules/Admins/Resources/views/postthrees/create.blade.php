                        ...
                        <div class="card-body">
                            ...
                            <div id="tab_vn" class="tabHide">
                                ...
                                <div class="form-group" style="display: none;">
                                    <label>Slug</label>
                                    <input type="text" name="slug" value="{{ time() }}" class="form-control" placeholder=""/>
                                </div>
                            ...
                            <div id="tab_en" class="tabHide" style="display: none;">
                                ...
                                <div class="form-group">
                                    <label>Địa chỉ</label>
                                    <textarea class="form-control" name="description_es" rows="10"></textarea>
                                </div>
                                <div class="form-group" class="form-group" style="display: none;">
                                    <label>Nội dung</label>
                                    <textarea class="form-control" name="content_es"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
