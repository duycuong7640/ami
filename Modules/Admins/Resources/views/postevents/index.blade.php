                ...
                <div class="d-flex flex-column flex-md-row align-items-center">
                    ...
                    <div class="wrapper ml-md-auto d-flex flex-column flex-md-row kanban-toolbar ml-n2 ml-md-0 mt-4 mt-md-0">
                        <div class="d-flex mt-4 mt-md-0">
                            <a href="{{ route('admin.pevent.create') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="icon-form" title="edit"
                                                   href="{{ route('admin.pevent.edit', ['id' => $row->id, 'page' => $data['list']->currentPage()]) }}">
                                                    <i class="icon-note"></i>
                                                </a>
                                                <a class="icon-form status active"
                                                   href="{{ route('admin.pevent.status', ['id' => $row->id, 'field' => 'status']) }}">
                                                    {!! (($row->status == 1) ? '<i class="icon-check"></i>' : '<i class="icon-close"></i>') !!}
                                                </a>
                                                <a class="icon-form"
                                                   href="javascript:confirmDelete('{{ route('admin.pevent.destroy', ['id' => $row->id]) }}','@lang('admins::layer.notify.confirm.delete')')">
...
{{--                                            <td>--}}
{{--                                                <a class="icon-form status active"--}}
{{--                                                   href="{{ route('admin.pevent.status', ['id' => $row->id, 'field' => 'choose_1']) }}">--}}
{{--                                                    {!! (($row->choose_1 == 1) ? '<i class="icon-check"></i>' : '<i class="icon-close"></i>') !!}--}}
{{--                                                </a>--}}
{{--                                            </td>--}}
                                            {{--                                        <td>--}}
                                            {{--                                            <a class="icon-form status active" href="{{ route('admin.pevent.status', ['id' => $row->id, 'field' => 'choose_2']) }}">--}}
                                            {{--                                                {!! (($row->choose_2 == 1) ? '<i class="icon-check"></i>' : '<i class="icon-close"></i>') !!}--}}
                                            {{--                                            </a>--}}
                                            {{--                                        </td>--}}
                                            {{--                                        <td>--}}
                                            {{--                                            <a class="icon-form status active" href="{{ route('admin.pevent.status', ['id' => $row->id, 'field' => 'choose_3']) }}">--}}
                                            {{--                                                {!! (($row->choose_3 == 1) ? '<i class="icon-check"></i>' : '<i class="icon-close"></i>') !!}--}}
                                            {{--                                            </a>--}}
                                            {{--                                        </td>--}}
                                            {{--                                        <td>--}}
                                            {{--                                            <a class="icon-form status active" href="{{ route('admin.pevent.status', ['id' => $row->id, 'field' => 'choose_4']) }}">--}}
