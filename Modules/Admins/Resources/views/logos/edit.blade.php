                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail2" class="form-control" value="{{ $data['detail']->thumbnail2 }}" type="text" name="thumbnail2"
                                                   readonly>
                                        </div>
                                    </div>
                                </div>
...
{{--                                    <option value="">Chọn loại</option>--}}
                                    <option value="logo" {{ ($data['detail']->type == 'logo') ? 'selected' : '' }}>Logo</option>
