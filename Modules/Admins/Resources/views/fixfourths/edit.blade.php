                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="tab_vn" class="tabHide">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <input id="thumbnail2" class="form-control"
                                                       value="{{ $data['detail']->thumbnail2 }}" type="text"
                                                       name="thumbnail2"
                                                       readonly>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group" style="display: none;">
                                    ...
                                    <select name="type" class="form-control col-md-3">
                                        ...
                                        <option value="fixfourth" {{ ($data['detail']->type == 'fixfourth') ? 'selected' : '' }}>
                                            fixfourth
                                        </option>
                            ...
                            <div id="tab_en" class="tabHide" style="display: none;">
                                ...
                                <div class="form-group">
                                    <label>Tiêu đề 2</label>
                                    <input type="text" name="title2_en" value="{{ $data['detail']->title2_en }}"
                                           class="form-control" placeholder=""/>
                                </div>
                            </div>
                        </div>
