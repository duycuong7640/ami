...
class FixthreesController extends Controller
{
    ...
    public function __construct(AdvertisementService $advertisementService)
    {
        ...
        $this->type = $this->advertisementService::TYPE[6];
    }
    ...
    public function index()
    {
        try {
            ...
            return view('admins::fixthrees.index', ['data' => $data]);
        } catch (\Exception $e) {
            abort('500');
        }
    }
    ...
    public function create()
    {
        try {
            ...
            return view('admins::fixthrees.create', ['data' => $data]);
        } catch (\Exception $e) {
            abort('500');
        }
    }
    ...
    public function store(CreateRequest $request)
    {
        try {
            ...
            if ($this->advertisementService->create($_params)) {
                return redirect(route('admin.fixthree.index'));
            } else {
    ...
    public function edit($id)
    {
        try {
            ...
            return view('admins::fixthrees.edit', ['data' => $data]);
        } catch (\Exception $e) {
    ...
    public function update(EditRequest $request, $id)
    {
        try {
            ...
            if ($this->advertisementService->update($_params, $id)) {
                ...
                return redirect(route('admin.fixthree.index', ['page' => (!empty($_GET['page']) ? $_GET['page'] : 1)]));
            } else {
                $errors = new MessageBag(['error' => __('admins::layer.notify.fail')]);
                return back()->withInput($_params)->withErrors($errors);
            }
